...
<!-- 表格主体内容 -->
                            <tbody>
                                <?php if(is_array($questions)): foreach($questions as $key=>$ques): ?><tr>
                                        <td>
                                        ...
                                        <td class="hidden-phone">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="/index.php/Admin/Questions/delquestion/id/<?php echo ($ques["id"]); ?>">删除</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>   
...
<!--页脚  -->
    ...
    <script type="text/javascript">
        ...
        $('#questionslist').attr("class","heading");
    </script>
