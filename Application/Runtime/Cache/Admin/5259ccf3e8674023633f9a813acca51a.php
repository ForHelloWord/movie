...
<!--副导航  -->
    ...
    <ul>
        <li><a href="/index.php/Admin/movie/movie" class="heading" id="movielist">影片资源列表</a></li>
...
<!-- 添加用户表单 -->
                                <div class="span9">
                                    <form class="form-horizontal" method="post" action="/index.php/Admin/Movie/update">
                                        <h5>填写电影信息</h5><hr>
                                        <div class="control-group">
                                            <label class="control-label">电影名称</label>
                                            <div class="controls">
                                                <span class="btn btn-info" disabled>
                                                    <?php echo ($movie["cname"]); ?>
                                                    <input type="hidden" name="ename" value="<?php echo ($movie["ename"]); ?>" >
                                                </span>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text"name="ename" value="<?php echo ($movie["ename"]); ?>" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
