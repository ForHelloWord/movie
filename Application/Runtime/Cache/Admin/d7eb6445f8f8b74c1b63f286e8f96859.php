...
<!--副导航  -->
    ...
    <ul>
        <li><a href="/index.php/Admin/Resource/showList" >影片资源列表</a></li>
        <li><a href="/index.php/Admin/Resource/add">添加影片资源</a></li>
        <!-- <li><a href="/index.php/Admin/classes/classes">电影分类管理</a></li> -->
        <li><a href="/index.php/Admin/Resource/trash"class="heading">回收站</a></li>
    </ul>
...
<!-- 表格主体内容 -->       <form action="/index.php/Admin/Resource/allTrash" method="post">
                            <tbody>
                                <?php if(is_array($resource)): foreach($resource as $key=>$vo): ?><tr>
                                    <td>
                                        <input type="checkbox" class="no-margin" name="rids[]"value="<?php echo ($vo["rid"]); ?>" />
                                    </td>
                                    ...
                                    <td class="hidden-phone">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="/index.php/Admin/Resource/edit/rid/<?php echo ($vo["rid"]); ?>">查看或修改影片详情</a>
                                                </li>
                                                <li>
                                                    <a href="/index.php/Admin/Resource/recover/rid/<?php echo ($vo["rid"]); ?>">还原</a>
                                                </li>
                                                <li>
                                                    <a href="/index.php/Admin/Resource/delete/rid/<?php echo ($vo["rid"]); ?>">彻底删除</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
