...
<!--副导航  -->
    ...
    <ul>
        ...
        <li><a href="/index.php/Admin/Resource/add" id="addlist">添加影片资源</a></li>
...
<!-- 添加用户表单 -->
                                <div class="span9">
                                    <form class="form-horizontal" method="post" action="/index.php/Admin/Resource/addOk" >
                                        <h5>填写影片资源信息</h5><hr>
                                        <div class="control-group">
                                            <label class="control-label">影片资源名称</label>
                                            <div class="controls">
                                                <input type="text" name="rname"required>
                                            </div>
                                        </div>
                                        <!--<div class="control-group">
                                            <label class="control-label">影片资源路径</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <label class="radio inline">
                                                <input type="radio" name="rpath" id="inlineRadioA"value="1" checked="checked">&nbsp默认
                                            </label>
                                            <!-- <label class="radio inline">
...
<!-- 电影资源上传 -->
      <!-- <script>
        ...
        $('#file_upload').uploadify({
            ...
            'uploader' : '<?php echo U("Resource/addOk");?>',
            'buttonText' : '上传影片海报',
